<template>
  <div class="section4">
    <div class="section-header">
      <h2 class="section-title">研发投入与创新关系交互分析</h2>
      <p class="section-subtitle">基于研究结论：研发投入占GDP比重每提升1%，全球创新指数(GII Score)平均增加0.78分</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    generateChartData() {
      ...
      // 当前设置点 - 确保数据格式统一
      const currentPoint = [
        Math.round(this.rdGdpRatio * 10) / 10,        // 保留1位小数
